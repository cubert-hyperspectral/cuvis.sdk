...
# Class cuvis::TiffExporter



[**ClassList**](annotated.md) **>** [**cuvis**](namespacecuvis.md) **>** [**TiffExporter**](classcuvis_1_1TiffExporter.md)
...
| Type | Name |
| ---: | :--- |
| typedef [**cuvis\_export\_tiff\_settings\_t**](structcuvis_1_1image__t.md) | [**format\_settings\_t**](#typedef-format_settings_t)  <br> |
...
| Type | Name |
| ---: | :--- |
|   | [**TiffExporter**](#function-tiffexporter) ([**TiffArgs**](structcuvis_1_1TiffArgs.md) [**const**](structcuvis_1_1image__t.md) & args) <br> |
...
```C++
using cuvis::TiffExporter::format_settings_t =  cuvis_export_tiff_settings_t;
```
...
### function TiffExporter 

```C++
cuvis::TiffExporter::TiffExporter (
    TiffArgs  const & args
) 
```
