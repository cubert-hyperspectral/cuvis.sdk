...
|  std::optional&lt; [**Measurement**](classcuvis_1_1Measurement.md) &gt; | [**get\_mesu**](#function-get_mesu) ([**int\_t**](group__typedefs.md#typedef-int_t) frameNo, [**session\_item\_type\_t**](group__typedefs.md#typedef-session_item_type_t) type=session\_item\_type\_t::session\_item\_type\_frames) const<br> |
...
|  [**int\_t**](group__typedefs.md#typedef-int_t) | [**get\_size**](#function-get_size) ([**session\_item\_type\_t**](group__typedefs.md#typedef-session_item_type_t) type=session\_item\_type\_t::session\_item\_type\_frames) const<br>_get size of the_ [_**SessionFile**_](classcuvis_1_1SessionFile.md) __ |
...
std::optional< Measurement > cuvis::SessionFile::get_mesu (
    int_t frameNo,
    session_item_type_t type=session_item_type_t::session_item_type_frames
) const
```
