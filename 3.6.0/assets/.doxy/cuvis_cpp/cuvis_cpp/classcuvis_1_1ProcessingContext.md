...
|  std::optional&lt; [**target\_spectrum\_t**](structcuvis_1_1target__spectrum__t.md) &gt; | [**get\_reference\_target\_spectrum**](#function-get_reference_target_spectrum) () const<br>_get the target reflectivity spectrum, if one is set_  |
|  std::optional&lt; [**sensor\_spectrum\_t**](structcuvis_1_1sensor__spectrum__t.md) &gt; | [**get\_reference\_white\_spectrum**](#function-get_reference_white_spectrum) () const<br>_get the white reference spectrum, if one is set_  |
...
|  [**void**](structcuvis_1_1image__t.md) | [**set\_reference\_target\_spectrum**](#function-set_reference_target_spectrum) ([**target\_spectrum\_t**](structcuvis_1_1target__spectrum__t.md) [**const**](structcuvis_1_1image__t.md) & spectrum) <br>_Set the reflectivity curve of the white target._  |
|  [**void**](structcuvis_1_1image__t.md) | [**set\_reference\_white\_spectrum**](#function-set_reference_white_spectrum) ([**sensor\_spectrum\_t**](structcuvis_1_1sensor__spectrum__t.md) [**const**](structcuvis_1_1image__t.md) & spectrum) <br>_Set an averaged sensor spectrum as the white reference._  |
...
### function get\_reference\_target\_spectrum 

_get the target reflectivity spectrum, if one is set_ 
```C++
std::optional< target_spectrum_t > cuvis::ProcessingContext::get_reference_target_spectrum () const
```
...
### function get\_reference\_white\_spectrum 

_get the white reference spectrum, if one is set_ 
```C++
std::optional< sensor_spectrum_t > cuvis::ProcessingContext::get_reference_white_spectrum () const
```



Returns an owning copy, including the effective bit depth and integration time the spectrum was set with. 
...
### function set\_reference\_target\_spectrum 

_Set the reflectivity curve of the white target._ 
```C++
void cuvis::ProcessingContext::set_reference_target_spectrum (
    target_spectrum_t  const & spectrum
) 
```



Fills the Reference\_TargetSpectrum slot. When no target spectrum is set, a perfectly white target (reflectivity 1.0 everywhere) is assumed.
...
* `spectrum` wavelengths [nm] and reflectivity fractions (1.0 = 100 percent), equally long and non-empty 
...
### function set\_reference\_white\_spectrum 

_Set an averaged sensor spectrum as the white reference._ 
```C++
void cuvis::ProcessingContext::set_reference_white_spectrum (
    sensor_spectrum_t  const & spectrum
) 
```



Fills the Reference\_WhiteSpectrum slot, which replaces a white reference measurement in the reflectance calculation. Setting the spectrum clears a previously set white measurement, and setting a white measurement clears the spectrum.
...
* `spectrum` wavelengths [nm], raw counts (equally long and non-empty), effective bit depth (1 to 16) and integration time [ms] 
