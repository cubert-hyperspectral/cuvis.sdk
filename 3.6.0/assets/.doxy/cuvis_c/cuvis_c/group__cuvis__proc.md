...
|  [**SDK\_CAPI**](cuvis_8h.md#define-sdk_capi) [**CUVIS\_STATUS**](cuvis_8h.md#define-cuvis_status) [**SDK\_CCALL**](cuvis_8h.md#define-sdk_ccall) | [**cuvis\_proc\_cont\_get\_reference\_target\_spectrum**](#function-cuvis_proc_cont_get_reference_target_spectrum) ([**CUVIS\_PROC\_CONT**](cuvis_8h.md#define-cuvis_proc_cont) i\_procCont, [**CUVIS\_TARGET\_SPECTRUM**](cuvis_8h.md#define-cuvis_target_spectrum) \* o\_pSpectrum) <br>_Borrow the target reflectance spectrum._  |
|  [**SDK\_CAPI**](cuvis_8h.md#define-sdk_capi) [**CUVIS\_STATUS**](cuvis_8h.md#define-cuvis_status) [**SDK\_CCALL**](cuvis_8h.md#define-sdk_ccall) | [**cuvis\_proc\_cont\_get\_reference\_white\_spectrum**](#function-cuvis_proc_cont_get_reference_white_spectrum) ([**CUVIS\_PROC\_CONT**](cuvis_8h.md#define-cuvis_proc_cont) i\_procCont, [**CUVIS\_SENSOR\_SPECTRUM**](cuvis_8h.md#define-cuvis_sensor_spectrum) \* o\_pSpectrum) <br>_Borrow the white reference spectrum._  |
...
|  [**SDK\_CAPI**](cuvis_8h.md#define-sdk_capi) [**CUVIS\_STATUS**](cuvis_8h.md#define-cuvis_status) [**SDK\_CCALL**](cuvis_8h.md#define-sdk_ccall) | [**cuvis\_proc\_cont\_set\_reference\_target\_spectrum**](#function-cuvis_proc_cont_set_reference_target_spectrum) ([**CUVIS\_PROC\_CONT**](cuvis_8h.md#define-cuvis_proc_cont) i\_procCont, [**CUVIS\_TARGET\_SPECTRUM**](cuvis_8h.md#define-cuvis_target_spectrum) const \* i\_spectrum) <br>_Set the white-target reflectance spectrum._  |
|  [**SDK\_CAPI**](cuvis_8h.md#define-sdk_capi) [**CUVIS\_STATUS**](cuvis_8h.md#define-cuvis_status) [**SDK\_CCALL**](cuvis_8h.md#define-sdk_ccall) | [**cuvis\_proc\_cont\_set\_reference\_white\_spectrum**](#function-cuvis_proc_cont_set_reference_white_spectrum) ([**CUVIS\_PROC\_CONT**](cuvis_8h.md#define-cuvis_proc_cont) i\_procCont, [**CUVIS\_SENSOR\_SPECTRUM**](cuvis_8h.md#define-cuvis_sensor_spectrum) const \* i\_spectrum) <br>_Set the averaged white reference spectrum from raw sensor counts._  |
...
### function cuvis\_proc\_cont\_get\_reference\_target\_spectrum 

_Borrow the target reflectance spectrum._ 
```
SDK_CAPI  CUVIS_STATUS  SDK_CCALL cuvis_proc_cont_get_reference_target_spectrum (
    CUVIS_PROC_CONT i_procCont,
    CUVIS_TARGET_SPECTRUM * o_pSpectrum
) 
```
...
* `i_procCont` The handle of the processing context 
* `o_pSpectrum` Filled with pointers into SDK memory and the count; see [**cuvis\_target\_spectrum\_t**](structcuvis__target__spectrum__t.md) for their validity and the value convention 



**Returns:**

status\_ok if the spectrum was read, status\_not\_available when the Reference\_TargetSpectrum slot is empty. 
...
### function cuvis\_proc\_cont\_get\_reference\_white\_spectrum 

_Borrow the white reference spectrum._ 
```
SDK_CAPI  CUVIS_STATUS  SDK_CCALL cuvis_proc_cont_get_reference_white_spectrum (
    CUVIS_PROC_CONT i_procCont,
    CUVIS_SENSOR_SPECTRUM * o_pSpectrum
) 
```
...
* `i_procCont` The handle of the processing context 
* `o_pSpectrum` Filled with pointers into SDK memory, count, effective bit depth and integration time; see [**cuvis\_sensor\_spectrum\_t**](structcuvis__sensor__spectrum__t.md) for their validity 



**Returns:**

status\_ok if the spectrum was read, status\_not\_available when the Reference\_WhiteSpectrum slot is empty. 
...
### function cuvis\_proc\_cont\_set\_reference\_target\_spectrum 

_Set the white-target reflectance spectrum._ 
```
SDK_CAPI  CUVIS_STATUS  SDK_CCALL cuvis_proc_cont_set_reference_target_spectrum (
    CUVIS_PROC_CONT i_procCont,
    CUVIS_TARGET_SPECTRUM const * i_spectrum
) 
```



Overrides the default target of 100% reflectivity across the whole range. The spectrum is copied, the caller keeps ownership of the arrays.
...
* `i_procCont` The handle of the processing context 
* `i_spectrum` The spectrum to set into the Reference\_TargetSpectrum slot; see [**cuvis\_target\_spectrum\_t**](structcuvis__target__spectrum__t.md) for the value convention 



**Returns:**

status\_ok if the spectrum was set. 
...
### function cuvis\_proc\_cont\_set\_reference\_white\_spectrum 

_Set the averaged white reference spectrum from raw sensor counts._ 
```
SDK_CAPI  CUVIS_STATUS  SDK_CCALL cuvis_proc_cont_set_reference_white_spectrum (
    CUVIS_PROC_CONT i_procCont,
    CUVIS_SENSOR_SPECTRUM const * i_spectrum
) 
```



Replaces a white reference measurement for reflectance calculation; the two white sources are mutually exclusive, setting one clears the other. The spectrum is copied, the caller keeps ownership of the arrays.
...
* `i_procCont` The handle of the processing context 
* `i_spectrum` The spectrum to set into the Reference\_WhiteSpectrum slot; see [**cuvis\_sensor\_spectrum\_t**](structcuvis__sensor__spectrum__t.md) for the field semantics 
