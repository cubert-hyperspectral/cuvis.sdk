...
| struct | [**cuvis\_sensor\_spectrum\_t**](structcuvis__sensor__spectrum__t.md) <br>_An averaged spectrum of raw sensor counts._  |
| struct | [**cuvis\_session\_info\_t**](structcuvis__session__info__t.md) <br> |
| struct | [**cuvis\_target\_spectrum\_t**](structcuvis__target__spectrum__t.md) <br>_The reflectance spectrum of the white target used in the scene._  |
...
|   | [**ALLOCATE\_AND\_FREE**](#function-allocate_and_free) ([**CUVIS\_SENSOR\_SPECTRUM**](cuvis_8h.md#define-cuvis_sensor_spectrum), sensor\_spectrum) <br> |
|   | [**ALLOCATE\_AND\_FREE**](#function-allocate_and_free) ([**CUVIS\_TARGET\_SPECTRUM**](cuvis_8h.md#define-cuvis_target_spectrum), target\_spectrum) <br> |
...
| define  | [**CUVIS\_SENSOR\_SPECTRUM**](cuvis_8h.md#define-cuvis_sensor_spectrum)  `struct [**cuvis\_sensor\_spectrum\_t**](structcuvis__sensor__spectrum__t.md)`<br> |
...
| define  | [**CUVIS\_TARGET\_SPECTRUM**](cuvis_8h.md#define-cuvis_target_spectrum)  `struct [**cuvis\_target\_spectrum\_t**](structcuvis__target__spectrum__t.md)`<br> |
...
### define CUVIS\_SENSOR\_SPECTRUM 
...
### define CUVIS\_TARGET\_SPECTRUM 
