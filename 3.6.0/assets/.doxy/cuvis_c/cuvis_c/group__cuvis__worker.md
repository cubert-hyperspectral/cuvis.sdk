...
| Type | Name |
| ---: | :--- |
|  [**SDK\_CAPI**](cuvis_8h.md#define-sdk_capi) [**CUVIS\_STATUS**](cuvis_8h.md#define-cuvis_status) [**SDK\_CCALL**](cuvis_8h.md#define-sdk_ccall) | [**cuvis\_worker\_copy\_handle**](#function-cuvis_worker_copy_handle) ([**CUVIS\_WORKER**](cuvis_8h.md#define-cuvis_worker) i\_worker, [**CUVIS\_WORKER**](cuvis_8h.md#define-cuvis_worker) \* o\_pWorker) <br>_Creates an additional worker handle._  |
...
### function cuvis\_worker\_copy\_handle 

_Creates an additional worker handle._ 
```
SDK_CAPI  CUVIS_STATUS  SDK_CCALL cuvis_worker_copy_handle (
...
* `i_worker` The handle of the worker to copy 
* `o_pWorker` The new handle of the worker. 



**Returns:**

status\_ok if the worker handle could be doubled 
