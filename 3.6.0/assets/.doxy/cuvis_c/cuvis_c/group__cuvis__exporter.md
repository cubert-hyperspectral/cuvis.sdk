...
|  [**SDK\_CAPI**](cuvis_8h.md#define-sdk_capi) [**CUVIS\_STATUS**](cuvis_8h.md#define-cuvis_status) [**SDK\_CCALL**](cuvis_8h.md#define-sdk_ccall) | [**cuvis\_exporter\_copy\_handle**](#function-cuvis_exporter_copy_handle) ([**CUVIS\_EXPORTER**](cuvis_8h.md#define-cuvis_exporter) i\_exporter, [**CUVIS\_EXPORTER**](cuvis_8h.md#define-cuvis_exporter) \* o\_pExporter) <br>_Creates an additional exporter handle._  |
...
### function cuvis\_exporter\_copy\_handle 

_Creates an additional exporter handle._ 
```
SDK_CAPI  CUVIS_STATUS  SDK_CCALL cuvis_exporter_copy_handle (
    CUVIS_EXPORTER i_exporter,
...
* `i_exporter` The handle of the exporter to copy 
* `o_pExporter` The new handle of the exporter. 



**Returns:**

status\_ok if the exporter handle could be doubled 
